...
import com.bangkit.cakrawala.data.database.RemoteKeys
...
class HistoryRemoteMediator(
    ...
    override suspend fun load(
        ...
        try {
            val api = apiService.getHistoriesPaging(page, state.config.pageSize)
            ...
            database.withTransaction {
                ...
                responseData?.let {
                    database.historyDao().insertStory(it)
                }
            }
