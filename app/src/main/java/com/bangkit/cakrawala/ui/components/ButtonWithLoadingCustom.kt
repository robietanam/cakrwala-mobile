package com.bangkit.cakrawala.ui.components
...
class ButtonWithLoadingCustom : AppCompatButton{
    ...
    private fun init() {
        ...
        enabledBackground = ContextCompat.getDrawable(context, R.drawable.bg_button_loading) as Drawable
        disabledBackground = ContextCompat.getDrawable(context, R.drawable.bg_button_loading_disabled) as Drawable
    }
